...
def draw_circle(x, y, radius):
	drawing.oval(x - radius, y - radius, x + radius, y + radius, color = None, outline = 12, outline_color = get_next_color())
